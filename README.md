...
> ⚠️ **デモサイトご利用時の注意点**
> * **画像の公開について:** 本デモサイトで推論（クイズ生成）を実行すると、アップロードした画像は自動的にサーバーに保存され、**すべてのユーザーが閲覧・プレイできる状態（アーカイブ）になります。** 個人情報が含まれる画像や、公開されて困る画像はアップロードしないようご注意ください。
> * **既存の写真でのプレイ:** ご自身で画像をアップロードせずに体験したい場合は、画面右上の矢印アイコン（アーカイブパネル）を開くことで、**既に保存されている既存の写真を読み込んでクイズを遊ぶことが可能です。**
---
